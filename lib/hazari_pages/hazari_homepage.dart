...
import 'package:Card_Points/pages/history_page.dart';
...
class HazariHomePage extends StatefulWidget {
  const HazariHomePage({super.key});

  @override
  State<HazariHomePage> createState() => _HazariHomePageState();
}

class _HazariHomePageState extends State<HazariHomePage> {
